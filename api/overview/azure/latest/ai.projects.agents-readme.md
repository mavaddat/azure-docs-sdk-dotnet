...
ms.service: ai
---
# Azure AI Projects Agents client library for .NET - version 2.0.0 
...
More information about using the Azure.Monitor.OpenTelemetry.AspNetCore package can be found [here](https://github.com/Azure/azure-sdk-for-net/blob/Azure.AI.Projects.Agents_2.0.0/sdk/monitor/Azure.Monitor.OpenTelemetry.AspNetCore/README.md).
...
[aiprojects_contrib]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.AI.Projects.Agents_2.0.0/CONTRIBUTING.md
