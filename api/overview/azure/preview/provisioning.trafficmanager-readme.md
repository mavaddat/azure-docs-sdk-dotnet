---
title: Azure Provisioning TrafficManager client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.TrafficManager, trafficmanager
ms.date: 07/10/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: trafficmanager
---
# Azure Provisioning TrafficManager client library for .NET - version 1.0.0-beta.1 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.TrafficManager_1.0.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
