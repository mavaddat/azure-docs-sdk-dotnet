---
title: Azure Provisioning IotHub client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.IotHub, iothub
ms.date: 08/12/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: iothub
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.IotHub_1.0.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
