...
---
# Azure Provisioning Sql client library for .NET - version 1.2.0-beta.2 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.Sql_1.2.0-beta.2/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
