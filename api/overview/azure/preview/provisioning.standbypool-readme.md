---
title: Azure Provisioning StandbyPool client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.StandbyPool, standbypool
ms.date: 07/14/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: standbypool
---
# Azure Provisioning StandbyPool client library for .NET - version 1.0.0-beta.1 
...
```dotnetcli
dotnet add package Azure.Provisioning.StandbyPool --prerelease
```
...
This example demonstrates how to create an Azure Standby Virtual Machine Pool resource.

```C# Snippet:StandbyPoolBasic
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.StandbyPool_1.0.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
