...
ms.service: ai
---
# Azure AI Projects Agents client library for .NET - version 3.0.0-beta.3 
...
In the example below, we use C# source code.
...
More information about using the Azure.Monitor.OpenTelemetry.AspNetCore package can be found [here](https://github.com/Azure/azure-sdk-for-net/blob/Azure.AI.Projects.Agents_3.0.0-beta.3/sdk/monitor/Azure.Monitor.OpenTelemetry.AspNetCore/README.md).
...
[aiprojects_contrib]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.AI.Projects.Agents_3.0.0-beta.3/CONTRIBUTING.md
