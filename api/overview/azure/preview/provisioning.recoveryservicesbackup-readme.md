---
title: Azure Provisioning RecoveryServicesBackup client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.RecoveryServicesBackup, recoveryservices-backup
ms.date: 08/12/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: recoveryservices-backup
---
# Azure Provisioning RecoveryServicesBackup client library for .NET - version 1.0.0-beta.1 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.RecoveryServicesBackup_1.0.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
