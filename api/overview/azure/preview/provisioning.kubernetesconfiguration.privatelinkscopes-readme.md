---
title: Azure Provisioning KubernetesConfiguration PrivateLinkScopes client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.KubernetesConfiguration.PrivateLinkScopes, kubernetesconfiguration
ms.date: 08/26/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: kubernetesconfiguration
---
# Azure Provisioning KubernetesConfiguration PrivateLinkScopes client library for .NET - version 1.0.0-beta.1 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning.KubernetesConfiguration.PrivateLinkScopes_1.0.0-beta.1/CONTRIBUTING.md
